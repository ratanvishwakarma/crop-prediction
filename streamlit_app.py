...
N = float(st.number_input('Nitrogen', 0,200))
P = float(st.number_input('Phosphorus', 0,200))
K = float(st.number_input('Potassium', 0,200))
temperature = float(st.number_input('Temperature', 0,200))
humidity = float(st.number_input('Humidity', 0,200))
